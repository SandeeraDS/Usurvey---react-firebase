...
class Usurvey extends Component {
  //this come for submitting a form.
  nameSubmit(event) {
  ...
  render() {
    ...
    if (this.state.studentName === "" && this.state.isSubmitted === false) {
      ...
      questions = (
        <div>
          ...
          <form onSubmit={this.questionSubmitted}>
            ...
            <div className="card">
              <label>Is online learing helpful: </label>
              <br />
              <input
                type="radio"
                name="answer3"
      ...
      studentName = <div>thanks, {this.state.studentName}</div>;
    }
